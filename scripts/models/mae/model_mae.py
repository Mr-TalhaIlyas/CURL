# -*- coding: utf-8 -*-
"""
Created on Fri Sep  6 09:10:57 2024
...
# model_mae = MaskedAutoencoderViT(img_size=224,
#                                 patch_size=16,
#                                 in_chans=3,
#                                 num_frames=16,
#                                 t_patch_size=2,
...
#                                 norm_layer=partial(nn.LayerNorm, eps=1e-6))
#%%
# img = torch.randn((4,3,16,224,224))

# loss, pred, mask = model_mae(img, 0.75)

#%%

# torch.save({'state_dict':model_mae.state_dict()}, 'C:/Users/talha/Desktop/test_mae/mae.pt')